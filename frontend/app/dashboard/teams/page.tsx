        ...
        <div className="space-y-6">
            ...
            {teams.length === 0 && !loading ? (
                <div className="text-center py-12 bg-white rounded-xl border border-gray-200 border-dashed">
                    ...
                    <p className="text-gray-500 mt-1 mb-4">Comece criando sua primeira equipe.</p>
                </div>
            ) : (
                        ...
                        <div key={team.id} className="relative group">
                            ...
                            <div className="absolute top-4 right-4 flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity z-10">
                                <button
                                    ...
                                    className="p-1.5 bg-white shadow rounded-md text-indigo-600 hover:bg-gray-50 border border-gray-100"
                                    title="Editar"
                                >
                                ...
                                <button
                                    ...
                                    className="p-1.5 bg-white shadow rounded-md text-red-600 hover:bg-gray-50 border border-gray-100"
                                    title="Excluir"
                                >
