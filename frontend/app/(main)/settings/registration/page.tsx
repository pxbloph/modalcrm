    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center bg-card p-6 rounded-xl shadow-sm border border-border">
                <div>
                    <h1 className="text-2xl font-bold text-foreground">Configurar Cadastro</h1>
                    <p className="text-muted-foreground mt-1">Personalize os campos do formulário de novos clientes.</p>
                </div>
                <button
                    onClick={handleSave}
                    disabled={saving}
